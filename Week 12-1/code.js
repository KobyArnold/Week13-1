...
function setTime() {
    ...
    //1. need to extract the number in the form
    var numOfSec = document.getElementById("timeInput").value;
    //2. use the number to create timers
    //time for a loop
    ...
    //3. use the number to play music after number of seconds
    setTimeout(function () {
        console.log("playStation() started")
        playStation();
    }, numOfSec * 1000);
